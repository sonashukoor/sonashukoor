...
🎓 CSE Undergrad (Honours in Machine Learning) 
🧠 Curious about how machines can mimic (or understand?) human thought  
📊 Currently diving into predictive analytics, cognition & behaviour modelling  
🎨 Also obsessed with blending design + tech — AI x Creativity is my jam  
🤝 Open to collaborations on AI, ML, creative tech, and anything fun  
💬 Let’s talk code, ideas, or random thoughts — I’m all ears! 

> ✍️ Can an algorithm be creative if its only sense of art is what happened in the past? - Hannah Fry
